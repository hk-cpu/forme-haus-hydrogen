  ...
  features: [
    {
      ...
      description:
        'Sourced from the finest mills in Italy and France, our fabrics undergo a rigorous selection process ensuring only the highest quality materials touch your skin.',
      image:
    ...
    },
    {
      ...
      description:
        'Each piece is handcrafted by master artisans with decades of experience in luxury fashion. Every stitch tells a story of dedication and precision.',
      image:
    ...
    },
    {
      ...
      description:
        'From hand-stitched lapels to genuine horn buttons, every detail speaks of uncompromising quality and attention to the finest elements.',
      image:
    ...
    },
    {
      ...
      description:
        'Committed to responsible fashion with eco-conscious materials and ethical production practices that honor both craft and planet.',
      image:

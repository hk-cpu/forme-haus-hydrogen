        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#8B8076]/10">
            ...
            <div className="grid grid-cols-3 gap-2 mb-5">
              <a href="https://www.instagram.com/formee.haus" target="_blank" rel="noopener noreferrer" className="aspect-square overflow-hidden rounded-lg">
                <img src="/brand/ig-post-1.webp" alt="Instagram post" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
              </a>
              <a href="https://www.instagram.com/formee.haus" target="_blank" rel="noopener noreferrer" className="aspect-square overflow-hidden rounded-lg">
                <img src="/brand/ig-post-2.jpg" alt="Instagram post" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
              </a>
              <a href="https://www.instagram.com/formee.haus" target="_blank" rel="noopener noreferrer" className="aspect-square overflow-hidden rounded-lg">
                <img src="/brand/ig-post-3.webp" alt="Instagram post" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
              </a>
            </div>
            <a href="https://www.instagram.com/formee.haus" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#a87441] font-medium text-[13px]">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">

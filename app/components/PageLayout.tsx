  ...
  return (
    <>
      <div className="flex flex-col min-h-screen relative">
        ...
        {/* Header rendered outside constraining wrappers so fixed positioning spans full viewport */}
        <Header
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M12.065 1.554c3.179 0 5.878 2.115 6.638 5.047.133.512.188 1.044.171 1.567.084-.043.18-.065.278-.065.415 0 .848.313.848.938 0 .548-.355.902-.784 1.019-.096.027-.207.043-.32.06-.54.086-.817.37-1.022.818a.42.42 0 0 0-.035.192c0 .086.022.17.057.246.38.826 1.273 1.855 2.862 2.25.128.033.192.173.128.289-.578 1.05-1.925 1.367-2.667 1.5a.342.342 0 0 0-.267.213c-.107.27-.096.536-.021.793.086.294.043.494-.086.644-.24.278-.64.326-.97.326-.224 0-.384-.032-.48-.054-.288-.064-.558-.096-.792-.096-.256 0-.416.043-.534.075-.544.154-1.003.6-1.812 1.14-.886.588-1.81.888-2.79.888-.98 0-1.904-.3-2.79-.888-.81-.54-1.27-.986-1.812-1.14a1.65 1.65 0 0 0-.534-.075c-.234 0-.504.032-.793.096-.096.022-.256.054-.48.054-.33 0-.73-.048-.97-.326-.128-.15-.17-.35-.085-.644.075-.257.085-.523-.021-.793a.342.342 0 0 0-.267-.213c-.742-.133-2.09-.45-2.667-1.5a.235.235 0 0 1 .128-.29c1.59-.394 2.482-1.423 2.862-2.249a.556.556 0 0 0 .057-.246.42.42 0 0 0-.035-.192c-.205-.448-.48-.732-1.022-.818-.113-.017-.224-.033-.32-.06C2.808 9.856 2.453 9.502 2.453 8.954c0-.625.433-.938.848-.938.098 0 .194.022.278.065a6.592 6.592 0 0 1 .171-1.567C4.51 3.67 7.21 1.554 12.065 1.554z" />
              </svg>
            </a>
            <a

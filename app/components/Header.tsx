  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={`fixed z-50 top-0 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] flex justify-center left-0 right-0 group w-full md:top-10 ${getHeaderBackgroundClass()}`}
        style={{

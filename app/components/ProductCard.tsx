        ...
        >
          ...
          >
            <div className="space-y-1">
              ...
              <div className="text-[#F0EAE6]/50 text-[10px] uppercase tracking-[0.2em] flex gap-2">
                 <Money data={price} data-test="price" />
                 {compareAtPrice && (
                    <Money data={compareAtPrice} className="line-through opacity-50" />
                 )}
              </div>
            </div>
          </div>

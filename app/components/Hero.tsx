...
export default function Hero() {
  ...
  return (
    <section aria-label="Hero" className="h-screen min-h-screen flex flex-col items-center justify-center bg-transparent relative overflow-hidden pt-[72px] md:pt-[100px]">

...
export function TopBar() {
  ...
  const socialLinks = [
    {icon: Icons.Instagram, href: 'https://instagram.com/formehaus', label: 'Instagram'},
    {icon: Icons.Twitter, href: 'https://twitter.com/formehaus', label: 'Twitter'},
    {icon: Icons.TikTok, href: 'https://tiktok.com/@formehaus', label: 'TikTok'},
  ];

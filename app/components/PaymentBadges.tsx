...
function MadaBadge({name, description}: PaymentBadgeProps) {
  return (
    ...
    >
      ...
      <span className="text-[10px] font-semibold text-[#2C2419] uppercase tracking-wide hidden sm:inline">
        {name}
      </span>
    </div>
  );
...
function TabbyBadge({name, description}: PaymentBadgeProps) {
  return (
    ...
    >
      ...
      <span className="text-[10px] font-semibold text-[#000] uppercase tracking-wide hidden sm:inline">
        {name}
      </span>
    </div>
  );

...
export const translations = {
  EN: {
    ...
    'home.brandIntro':
      'FORMÉ HAUS Collection is an Australian Tech Accessory brand owned, run and led by women.',
    'home.curatedForYou': 'Where Elegance Begins',
    'home.journal': 'The Journal',
    ...
    'footer.newsletterDesc': 'Be the first to know about new drops, exclusive offers, and Haus updates.',
  ...
  AR: {
    ...
    'home.brandIntro':
      'مجموعة فورميه هاوس هي علامة تجارية أسترالية لإكسسوارات التكنولوجيا تملكها وتديرها وتقودها نساء.',
    ...
    'footer.newsletter': 'انضم إلى الهاوس',
    'footer.newsletterDesc': 'كن أول من يعرف عن الإصدارات الجديدة والعروض الحصرية وأخبار الهاوس.',

...
export const TRANSLATION_FIXES = {
  ...
  'cart.saudiAddr':
    'للعملاء في المملكة: يُرجى استخدام العنوان الوطني المكوّن من ٨ أرقام لضمان التوصيل.',
  ...
  'search.noResults':
    'لم نجد ما تبحثين عنه 💭 جربي كلمات مختلفة أو تصفحي مجموعاتنا',
...
export const MISSING_TRANSLATION_KEYS = {
  ...
  'trust.paymentMethodsAr':
    'طرق دفع متعددة عبر Tap: مدى، Visa، Mastercard، Apple Pay، STC Pay، تابي، تمارا',
